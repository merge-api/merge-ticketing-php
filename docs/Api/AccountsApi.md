...
```php
accountsList($xAccountToken, $createdAfter, $createdBefore, $cursor, $includeDeletedData, $includeRemoteData, $modifiedAfter, $modifiedBefore, $pageSize, $remoteId): \OpenAPI\Client\Model\PaginatedAccountList
```
...
try {
    $result = $apiInstance->accountsList($xAccountToken, $createdAfter, $createdBefore, $cursor, $includeDeletedData, $includeRemoteData, $modifiedAfter, $modifiedBefore, $pageSize, $remoteId);
    print_r($result);
} catch (Exception $e) {
...
[**\OpenAPI\Client\Model\PaginatedAccountList**](../Model/PaginatedAccountList.md)
...
```php
accountsRetrieve($xAccountToken, $id, $includeRemoteData): \OpenAPI\Client\Model\Account
```
...
try {
    $result = $apiInstance->accountsRetrieve($xAccountToken, $id, $includeRemoteData);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling AccountsApi->accountsRetrieve: ', $e->getMessage(), PHP_EOL;
}
```
