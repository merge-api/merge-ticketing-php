...
```php
tagsList($xAccountToken, $createdAfter, $createdBefore, $cursor, $includeDeletedData, $includeRemoteData, $modifiedAfter, $modifiedBefore, $pageSize, $remoteId): \OpenAPI\Client\Model\PaginatedTagList
```
...
try {
    $result = $apiInstance->tagsList($xAccountToken, $createdAfter, $createdBefore, $cursor, $includeDeletedData, $includeRemoteData, $modifiedAfter, $modifiedBefore, $pageSize, $remoteId);
    print_r($result);
} catch (Exception $e) {
...
```php
tagsRetrieve($xAccountToken, $id, $includeRemoteData): \OpenAPI\Client\Model\Tag
```
...
try {
    $result = $apiInstance->tagsRetrieve($xAccountToken, $id, $includeRemoteData);
    print_r($result);
} catch (Exception $e) {
