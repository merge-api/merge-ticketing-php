...
class AvailableActionsApi
{
     ...
     */
    public function availableActionsRetrieve($xAccountToken)
    {
        list($response) = $this->availableActionsRetrieveWithHttpInfo($xAccountToken);
        return $response;
    }
     ...
     */
    public function availableActionsRetrieveWithHttpInfo($xAccountToken)
    {
        $request = $this->availableActionsRetrieveRequest($xAccountToken);
     ...
     */
    public function availableActionsRetrieveAsync($xAccountToken)
    {
        return $this->availableActionsRetrieveAsyncWithHttpInfo($xAccountToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function availableActionsRetrieveAsyncWithHttpInfo($xAccountToken)
    {
        $returnType = '\OpenAPI\Client\Model\AvailableActions';
        $request = $this->availableActionsRetrieveRequest($xAccountToken);
     ...
     */
    public function availableActionsRetrieveRequest($xAccountToken)
    {
        // verify the required parameter 'xAccountToken' is set
        if ($xAccountToken === null || (is_array($xAccountToken) && count($xAccountToken) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xAccountToken when calling availableActionsRetrieve'
            );
        }
