...
class ForceResyncApi
{
     ...
     */
    public function syncStatusResyncCreate($xAccountToken)
    {
        list($response) = $this->syncStatusResyncCreateWithHttpInfo($xAccountToken);
        return $response;
    }
     ...
     */
    public function syncStatusResyncCreateWithHttpInfo($xAccountToken)
    {
        $request = $this->syncStatusResyncCreateRequest($xAccountToken);
     ...
     */
    public function syncStatusResyncCreateAsync($xAccountToken)
    {
        return $this->syncStatusResyncCreateAsyncWithHttpInfo($xAccountToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function syncStatusResyncCreateAsyncWithHttpInfo($xAccountToken)
    {
        $returnType = '\OpenAPI\Client\Model\SyncStatus[]';
        $request = $this->syncStatusResyncCreateRequest($xAccountToken);
     ...
     */
    public function syncStatusResyncCreateRequest($xAccountToken)
    {
        // verify the required parameter 'xAccountToken' is set
        if ($xAccountToken === null || (is_array($xAccountToken) && count($xAccountToken) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xAccountToken when calling syncStatusResyncCreate'
            );
        }
