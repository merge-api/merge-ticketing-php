...
class AccountDetailsApi
{
     ...
     */
    public function accountDetailsRetrieve($xAccountToken)
    {
        list($response) = $this->accountDetailsRetrieveWithHttpInfo($xAccountToken);
        return $response;
    }
     ...
     */
    public function accountDetailsRetrieveWithHttpInfo($xAccountToken)
    {
        $request = $this->accountDetailsRetrieveRequest($xAccountToken);
     ...
     */
    public function accountDetailsRetrieveAsync($xAccountToken)
    {
        return $this->accountDetailsRetrieveAsyncWithHttpInfo($xAccountToken)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function accountDetailsRetrieveAsyncWithHttpInfo($xAccountToken)
    {
        $returnType = '\OpenAPI\Client\Model\AccountDetails';
        $request = $this->accountDetailsRetrieveRequest($xAccountToken);
     ...
     */
    public function accountDetailsRetrieveRequest($xAccountToken)
    {
        // verify the required parameter 'xAccountToken' is set
        if ($xAccountToken === null || (is_array($xAccountToken) && count($xAccountToken) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $xAccountToken when calling accountDetailsRetrieve'
            );
        }
