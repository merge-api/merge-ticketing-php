...
class AccountIntegration implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Gets categories
     *
     * @return \OpenAPI\Client\Model\CategoriesEnum[]|null
     */
     ...
     * Sets categories
     *
     * @param \OpenAPI\Client\Model\CategoriesEnum[]|null $categories Category or categories this integration belongs to. Multiple categories should be comma separated.<br/><br>Example: For [ats, hris], enter <i>ats,hris</i>
     *
     * @return self
     */
     ...
     * Sets squareImage
     *
     * @param string|null $squareImage Company logo in square shape. <b>Upload an image with a white background.</b>
     *
     * @return self
     */
