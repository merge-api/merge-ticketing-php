...
class AccountToken implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['accountToken'] = $data['accountToken'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accountToken'] === null) {
            $invalidProperties[] = "'accountToken' can't be null";
        }
     ...
     * Sets accountToken
     *
     * @param string $accountToken accountToken
     *
     * @return self
     */
